...
Indiana University
Make sure to enter the name and case exactly as above and enter the plus_code and your Python code below. Hint: The first five characters of the plus_code are "86FMQ ..."
...
js = json.loads(data)
print(json.dumps(js, indent=2))  # 👈 Esto mostrará la estructura del JSON

# Buscar plus_code en el lugar correcto
try:
